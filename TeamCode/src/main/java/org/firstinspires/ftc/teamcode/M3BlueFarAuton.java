...
public class M3BlueFarAuton extends LinearOpMode {
    private NewBluePropProcessor.Location location = NewBluePropProcessor.Location.MIDDLE;
    ...
    public void runOpMode(){
        ...
        visionPortal = VisionPortal.easyCreateWithDefaults(
                hardwareMap.get(WebcamName.class, "Webcam 1"), aprilTagProcessor, bluePropProcessor);
